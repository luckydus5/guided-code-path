...
export default function Learn() {
  ...
  const progress = ((currentChallengeIndex + 1) / languageChallenges.length) * 100;
  ...
  const runCode = async () => {
    ...
    setTimeout(() => {
      ...
      if (isCorrect) {
        ...
        setTimeout(() => {
          if (currentChallengeIndex < languageChallenges.length - 1) {
            setCurrentChallengeIndex(prev => prev + 1);
            setTestResult(null);
            addAIMessage(`Let's move on to: "${languageChallenges[currentChallengeIndex + 1].title}". ${languageChallenges[currentChallengeIndex + 1].description}`);
          }
        }, 2000);
      } else {
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="text-sm text-muted-foreground">
                Challenge {currentChallengeIndex + 1} of {languageChallenges.length}
              </div>
